...
codeunit 51898 "C5 2008 Install"
{
    ...
    begin
        ...
        DataClassificationMgt.SetTableFieldsToNormal(Database::"C5 2008 CustDiscGroup");

        DataClassificationMgt.SetTableFieldsToNormal(Database::"C5 2008 ProcCode");
        ...
        DataClassificationMgt.SetTableFieldsToNormal(Database::"C5 2008 CustContact");
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(Name));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(Address1));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(Address2));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(ZipCity));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(Country));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(Phone));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(Fax));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(Email));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(CellPhone));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 CustContact", C5CustContact.FieldNo(LocalNumber));
        ...
        DataClassificationMgt.SetTableFieldsToNormal(Database::"C5 2008 VendDiscGroup");

        DataClassificationMgt.SetTableFieldsToNormal(Database::"C5 2008 VendGroup");

        DataClassificationMgt.SetTableFieldsToNormal(Database::"C5 2008 VendTrans");
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTrans", C5VendTrans.FieldNo(ApprovedBy));

        DataClassificationMgt.SetTableFieldsToNormal(Database::"C5 2008 VendTable");
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(Name));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(Address1));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(Address2));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(ZipCity));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(Country));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(Phone));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(Fax));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(ImageFile));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(Language_));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(Email));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(URL));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(CellPhone));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(KrakNumber));
        DataClassificationMgt.SetFieldToPersonal(Database::"C5 2008 VendTable", C5VendTable.FieldNo(EanNumber));
    end;
}