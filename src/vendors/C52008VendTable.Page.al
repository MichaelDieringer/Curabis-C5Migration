...
/// </summary>
page 51861 "C5 2008 VendTable"
{
    PageType = Card;
    SourceTable = "C5 2008 VendTable";
    DeleteAllowed = false;
    InsertAllowed = false;
        ...
        area(Navigation)
        {
            group(RelatedEntities)
            {
                ...
                action(C5DiscGroup)
                {
                    ...
                    PromotedOnly = true;
                    Image = Discount;
                    RunObject = Page "C5 2008 VendDiscGroup";
                ...
                action(C5VendGroup)
                {
                    ...
                    PromotedOnly = true;
                    Image = Group;
                    RunObject = Page "C5 2008 VendGroup";
                ...
                action(C5VendTrans)
                {
                    ...
                    PromotedOnly = true;
                    Image = EntriesList;
                    RunObject = Page "C5 2008 VendTrans";
