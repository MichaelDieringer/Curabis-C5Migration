...
codeunit 51872 "C5 2008 Telemetry"
{
    var
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"C5 2008 Unzip", OnZipFileBlobMissing, '', false, false)]
    local procedure OnZipFileBlobMissingSubscriber()
    var
        C5MigrationDashboardMgt: Codeunit "C5 2008 Migr. Dashboard Mgt";
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"C5 2008 Data Migration Mgt.", OnCopyToDataBaseFailed, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"C5 2008 Unzip", OnUnzipFileError, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"C5 2008 Schema Reader", OnDefinitionFileMissing, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"C5 2008 Data Loader", OnFillStagingTablesStarted, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"C5 2008 Data Loader", OnFillStagingTablesFinished, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"C5 2008 Wizard Integration", OnC5MigrationSelected, '', false, false)]
    local procedure OnC5MigrationSelectedSubscriber()
    var
        C5MigrationDashboardMgt: Codeunit "C5 2008 Migr. Dashboard Mgt";
    begin
        Session.LogMessage('00001K5', 'C5 2008 Migration was selected.', Verbosity::Normal, DataClassification::SystemMetadata, TelemetryScope::ExtensionPublisher, 'Category', C5MigrationDashboardMgt.GetC5MigrationTypeTxt());
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::"C5 2008 Wizard Integration", OnEntitiesToMigrateSelected, '', false, false)]
    ...
    var
        ...
        C5LedgerEntriesLbl: Label 'C5 2008 ledger entries: %1; ', Comment = '%1 C5 ledger entries';
    begin
        ...
        DataMigrationEntity.SetRange("Table ID", Database::"C5 2008 LedTrans");
        if DataMigrationEntity.FindFirst() then
