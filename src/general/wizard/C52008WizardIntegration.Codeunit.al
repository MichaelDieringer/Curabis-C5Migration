...
/// </summary>
codeunit 51861 "C5 2008 Wizard Integration"
{
    var
        C5DataMigrationMgt: Codeunit "C5 2008 Data Migration Mgt.";
        ...
        Instructions2Txt: Label '2. Open Microsoft Dynamics C5 2008, and export your database. (General > Setup > Administration > Multi > Export Database).';
    ...
    begin
        exit(codeunit::"C5 2008 Wizard Integration");
    end;
